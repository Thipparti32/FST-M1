...
SELECT a.customer_name AS "Customer Name" , a,city ,a,grade, b.salesman_name as "Salesman Name" , b.city FROM customers a  
...
SELECT a.customer_name AS "Customer Name" , a.city ,a.grade, b.salesman_name as "Salesman Name" , FROM customers a  
LEFT OUTER JOIN salesman b ON a.salesman_id=b.salesman_id WHERE a.grade<300  
ORDER BY a.customer_id;
...
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE a.customer_id = b.customer_id) 
UNION 
SELECT salesman_id,  FROM salesman a 
WHERE 1<(SELECT COUNT(*) FROM orders b WHERE a.salesman_id = b.salesman_id) 
ORDER BY customer_name;
